...
class TcpManagerClass(object):
    ...
    def __init__(self):
        ...
        self.__master_ip = sys.stdin.readline().rstrip("\n")  # IP address of Master device
        self.__master2slave = int(input("Please enter Master-to-Slave port: \n"))  # Com port
        self.__slave2master = int(input("Please enter Slave-to-Master port: \n")) # Com port
        self.__buffer_size = int(input("Please specify buffer size (Default = 1024)\n"))  # Buffer size
